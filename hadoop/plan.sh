...
# required.
pkg_source=https://github.com/apache/${pkg_name}/archive/rel/release-${pkg_version}.tar.gz
...
pkg_shasum=b9194a139b7ae0cf5b01f7425c4402247e466d1d99ad06d6113406b9fd843dbb
...
pkg_deps=(core/bash core/which core/coreutils)

pkg_dirname=${pkg_name}-rel-release-${pkg_version}
...
do_install() {
    ...
    for dir in bin etc include libexec sbin share; do
        cp -a hadoop-dist/target/hadoop-${pkg_version}/$dir $pkg_prefix
    done
}